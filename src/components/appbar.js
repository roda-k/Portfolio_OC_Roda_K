    ...
    <AppBarContainer>
        <AppBar position="fixed">
          <Toolbar className={classes.appbarStyle}>
            <Typography href="#top" className={classes.categoriesStyle} variant="body1" component="a">
              Présentation
            </Typography>
            <Typography href="#myprojects" className={classes.categoriesStyle} variant="body1" component="a">
              Projets
            </Typography>
            <Typography href="#skills" className={classes.categoriesStyle} variant="body1" component="a">
              Compétences
            </Typography>
          </Toolbar>
        </AppBar>
